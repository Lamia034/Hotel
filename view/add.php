...
<form method="POST" enctype="multipart/form-data" >
  ...
  <h2 style="color:white;">ADD Product</h2>
    ...
    <input type="number" name="RoomPrice" placeholder="Room Price"><br>
    <label for="RoomCateg">Category</label><br>
    <input type="text" name="RoomCateg" placeholder="Room Categ"><br>
    <label for="RoomDesc">description</label><br>
    <input type="text" name="RoomDesc" placeholder="Description"><br>
